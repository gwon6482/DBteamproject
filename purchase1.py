...
class purchase1(QtWidgets.QMainWindow):
    ...
    def Loginbutton_click(self):
        UserProfile_customer.StartUserProfile_customer(self.user_id)
        self.close()
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(30, 30, 90, 21))
        self.label.setObjectName("label")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(240, 70, 90, 23))
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(330, 70, 90, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "전체 판매자"))
        self.pushButton.setText(_translate("MainWindow", "판매자 물품 보기"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "북마크"))
